...
export class AddCourseComponent {
  ...
  constructor(
    ...
    this.registerForm = this.fb.group({
      ...
      CrsLevel: new FormControl(null, [Validators.required]),
  ...
  registerData(): void {
    ...
    if (token) {
      ...
      this.addCourse.crsCategory = Number(this.CrsCategory?.value);
      this.addCourse.crsLevel = Number(this.CrsLevel?.value);
